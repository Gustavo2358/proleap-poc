...
FAST_TESTS = ('ArchitectureBoundaryTest', 'HarnessDocsTest', 'SemanticProductEntryGobackTest', 'LocalizedInputCompletenessContractTest',
              'ScalarMoveCheckpoint4ATest', 'MoveDataSourceTest', 'PerformDiscoveryTest', 'PerformBasicTest', 'PerformFamilyTest', 'MultiCallProgramTest', 'CompositionalityContractTest', 'EvaluateFirstSliceTest', 'GoToFirstSliceTest', 'PartialProgramFactsTest', 'CallCheckpointW1ATest', 'IfCheckpointW2ATest',
