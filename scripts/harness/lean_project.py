...
FAST_TESTS = ('DeclarativeValueInferenceTest', 'CicsProgramControlTest', 'ArchitectureBoundaryTest', 'HarnessDocsTest', 'SemanticProductEntryGobackTest', 'SemanticProductCheckpoint7JsonTest', 'W1CompatibilityW2ATest', 'LocalizedInputCompletenessContractTest',
