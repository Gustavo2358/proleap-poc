...
FAST_TESTS = ('ConditionalDependencyFactsTest', 'CallLocalInputTest', 'SqlNormalCompletionTest', 'CicsConditionRegistrationTest', 'TextPredicateTest', 'DliCommandEffectsTest', 'LogicalInitialInvariantTest', 'CicsHostEffectsTest', 'ExceptionalHandlerContractTest', 'TerminalSendContractTest', 'ControlStorageDecouplingTest', 'CicsCommandContractTest', 'CicsAbendContractTest', 'CicsAbendInvariantTest', 'CicsHandlerProvenanceTest', 'CicsHandlerContractTest', 'EofUnitBoundaryTest', 'FixedTabNormalizationTest', 'SourceNormalizerTest', 'SourceNormalizationPreprocessingIntegrationTest', 'SourceProvenanceTest', 'FactDependencyLocalityTest', 'ControlTopologyAuthorityTest', 'FileTopologyAuthorityTest', 'PositiveMemoryTopologyTest', 'DependencyPreservationTest', 'SourceDependencyProducerTest', 'Db2SourceExtractorTest','LogicalTextDefaultTest', 'LogicalTextLayoutTest', 'FileScopeContractTest', 'EvidenceMetamorphicTest', 'ScopedStorageEvidenceTest', 'EvidencePreservationTest', 'AmbiguousCallStorageTest', 'ScopedInputTest', 'ScopedLayoutTest', 'ObservedDependenciesTest', 'RecallFirstEntryTest', 'StatementEffectSummaryTest', 'PartialWriteEffectsTest', 'ExecDliOpaqueTest', 'DeclarativeValueInferenceTest', 'CicsProgramControlTest', 'CicsFileControlTest', 'ArchitectureBoundaryTest', 'HarnessDocsTest', 'SemanticProductEntryGobackTest', 'SemanticProductCheckpoint7JsonTest', 'W1CompatibilityW2ATest', 'LocalizedInputCompletenessContractTest',
              'ScalarMoveCheckpoint4ATest', 'MoveDataSourceTest', 'PerformDiscoveryTest', 'PerformBasicTest', 'PartialStructuralFactsTest', 'ControlCompositionTest', 'PerformFamilyTest', 'PerformUntilTest', 'PerformTimesTest', 'PerformVaryingTest', 'MultiCallProgramTest', 'CompositionalityContractTest', 'EvaluateFirstSliceTest', 'GoToFirstSliceTest', 'ConditionalGoToTest', 'PartialProgramFactsTest', 'CallCheckpointW1ATest', 'IfCheckpointW2ATest',
