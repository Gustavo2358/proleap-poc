...
public interface CobolSemanticPort {
    ...
    default Optional<NominalValues> nominalValues() { return Optional.empty(); }
...
final class MaterializedCobolSemanticPort implements CobolSemanticPort {
    ...
    @Override public Optional<NominalValues> nominalValues() { return state.nominalValues(); }
    ...
    @Override
    public CobolSemanticProduct.StorageInventory storage() { return state.storage(); }
