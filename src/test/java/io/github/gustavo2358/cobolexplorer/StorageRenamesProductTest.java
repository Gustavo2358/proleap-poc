...
class StorageRenamesProductTest {
    ...
    @Test void unusedAliasesEndpointsAndOriginsArePublishedWithoutNewAllocation() throws Exception {
        ...
        assertEquals("2.17.0",doc.path("contractVersion").asText());var st=doc.path("storage");
        assertEquals("1.5.0",st.path("version").asText());assertEquals(1,st.path("bases").size());
