...
- [WORK-COND-002 — Decisão arquitetural para condições contextuais](active/WORK-COND-002/spec.md) — Slice 2 de BACKLOG-COND-001 no checkpoint arquitetural; propõe AST de superfície + produto pós-binding e proíbe implementação antes de review/merge e nova autorização.
