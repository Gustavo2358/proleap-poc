...
- [WORK-COND-005 — Contextualizar occurrences de condições](active/WORK-COND-005/spec.md) — Slice 5 de `BACKLOG-COND-001` no checkpoint de Discovery; implementação não autorizada.
