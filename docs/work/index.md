...
- [WORK-SEMANTIC-PRODUCT-001 — Semantic Product Boundary Discovery](active/WORK-SEMANTIC-PRODUCT-001/spec.md) — Checkpoint 1 concluído após remediation e aguardando novo review humano; Checkpoints 2 e 3 não autorizados, dependem de autorização explícita.
