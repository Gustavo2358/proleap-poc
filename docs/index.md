...
Os work items ativos estão no [índice de trabalho](work/index.md). `WORK-AST-002` possui implementação de F-02 integrada pelo PR #28. `WORK-SEMANTIC-PRODUCT-003` audita a boundary contra AIR 2.0.0, sem produção; consulte a [matriz bilateral](architecture/semantic-product-air-v2-audit.md). `WORK-SEMANTIC-PRODUCT-002` foi concluído no PR #27 e promoveu o [contrato atual](domain/cobol-semantic-product.md). `WORK-COND-001` foi concluído pelo PR #15, `WORK-COND-002` pelo PR #16, `WORK-COND-003` pelo PR #17, `WORK-COND-004` pelo PR #18 e `WORK-COND-005` pelo PR #19; todos possuem apenas [resumos históricos](work/history/WORK-COND-001.md). `WORK-AST-003` foi concluído pelos PRs #11/#12 e possui apenas um [resumo histórico](work/history/WORK-AST-003.md).
