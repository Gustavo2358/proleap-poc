...
Expansões compõem os segmentos existentes e acrescentam `CopyFrame`; `REPLACING` preserva origem aproximada. O resultado não recria identity map. A ordem de expansão e diagnostics acompanha a ordem estrutural do fonte.
