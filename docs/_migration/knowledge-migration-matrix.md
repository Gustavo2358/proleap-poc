...
| `scripts/source-normalizer-regression.sh` | cenário E2E | KM-GATE-001 | EVAL_ORACLE | atual | catálogo de evals; futuro check-full | EVAL-PROV-002 | MIGRATED | oracle catalogado; encapsulamento pertence à Fase 7 |
