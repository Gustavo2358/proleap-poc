...
| `specs/AGENTS.md — antlr-parse-tree-explorer.md` | §§1–6, 11–12, 21–22, 27–35, 38–39 | KM-IMP-SEM-001 | TESTING_POLICY | aprovado conceitualmente; validar contra estado atual | `docs/engineering/semantic-analysis-policy.md` | a definir | UNMAPPED | política semântica e fail-closed |
| mesmo | §§13–20 | KM-IMP-TEST-001 | TESTING_POLICY | aprovado conceitualmente; validar contra estado atual | `docs/engineering/semantic-testing.md` | a definir | UNMAPPED | equivalência, adversarial, propriedades e oráculos |
| mesmo | §§23–24 | KM-IMP-PERF-001 | PERFORMANCE_CONTRACT | atual quando compatível com código | `docs/engineering/performance-policy.md` | INV-PERF-* | UNMAPPED | não usar thresholds dependentes de hardware |
| mesmo | §§7–10, 25–26 | KM-IMP-ARCH-001 | ARCHITECTURE_BOUNDARY | validar | arquitetura/domain/invariantes | a definir | UNMAPPED | AST, binding, CFG/dataflow e linguagens embarcadas |
| mesmo | §§36–37 | KM-IMP-REVIEW-001 | OPERATIONAL_PROCEDURE | atual | semantic policy | — | UNMAPPED | comentários e red flags |
